...
export const STEP1_CONTENT: GuideStepContent = {
...
export interface Step2Section {
  title: string;
  groups: BulletGroup[];
  templateButton?: boolean;
}

export const STEP2_HEADER = {
...
export const STEP3_CHECKLIST: BulletGroup[] = [
  {
...
export const STEP6_WHERE_TO_FILE: BulletGroup[] = [
  {
...
export const STEP6_VISIT_IN_PERSON: BulletGroup[] = [
  {
...
export const STEP6_REQUIRED_DOCS: RequiredDoc[] = [
  { label: "신분증 (대표자 본인)" },
  { label: "사업자등록증 원본" },
  {
...
export const STEP6_BEFORE_FILING: BulletGroup[] = [
  {
...
export const STEP7_WHEN: BulletGroup[] = [
  {
...
export const STEP7_WITH_EMPLOYEES: BulletGroup[] = [
  {
...
export const STEP7_WITHOUT_EMPLOYEES: BulletGroup[] = [
  {
...
export const STEP7_WHERE: BulletGroup[] = [
  {
...
export const STEP7_HEALTH_INSURANCE: BulletGroup[] = [
  {
...
export const STEP8_DEADLINE: BulletGroup[] = [
  {
...
export const STEP8_REMAINING_ASSETS: BulletGroup[] = [
  {
...
export const STEP8_TEARDOWN_COST: BulletGroup[] = [
  {
...
export const STEP8_FILING_METHODS: BulletGroup[] = [
  {
...
export const STEP8_INCOME_TAX_ROWS = [
  {
    label: "종합소득세 확정신고 기한",
...
export const STEP8_INCOME_TAX_NOTE =
  "올해 1월 1일부터 폐업일까지의 최종 사업 소득 실적을 내년 5월에 정산 완료하며 대장정이 마무리됩니다.";

export const STEP4_HEADER = {
...
export const STEP4_FIXTURES: BulletGroup[] = [
  {
...
export const STEP4_INVENTORY: BulletGroup[] = [
  {
...
export const STEP4_COMPARISON: { heading: string; items: string[] }[] = [
  {
    heading: "중고 직거래/업체",
...
export const STEP5_BEFORE_DEMOLITION: BulletGroup[] = [
  {
...
export const STEP5_DEMOLITION_TIPS: BulletGroup[] = [
  {
...
export const STEP9_DEADLINE: BulletGroup[] = [
  {
...
export const STEP9_LOSS_FILING: BulletGroup[] = [
  {
...
export const STEP9_DOCUMENTS: BulletGroup[] = [
  {
