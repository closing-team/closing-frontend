...
// 1:1 문의(inquiry) 도메인은 실제 백엔드로 연결돼 있어 더 이상 MSW로
// 모킹하지 않는다. mocks/product/, mocks/business/, mocks/account/,
// mocks/support/, mocks/inquiry/ 코드는 다시 목업으로 돌려야 할 때를
// 대비해 남겨두고, 여기서만 연결을 끊는다.
